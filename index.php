                        ...
                        <div class="login-register-form-wrap">
                            ...
                            <div class="login-register-form">
                                <form action="cek_login.php" method="post">
                                    <div class="row">
                                        <div class="col-12 mb-20"><input class="form-control" type="text" name="username" class="form_login" placeholder="User ID / Email"></div>
                                        <div class="col-12 mb-20"><input class="form-control" type="password" name="password" class="form_login"placeholder="Password" ></div>
                                        ...
                                        <div class="col-12">
                                            <div class="row justify-content-between">
                                                ...
                                                <div class="col-auto mb-15">Dont have account? <a href="admin/register.php">Create Now.</a></div>
                                            </div>
                                        </div>
