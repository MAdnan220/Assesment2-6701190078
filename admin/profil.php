...
<head>
    ...
    <title>Assesment 2 Pengembangan WEB</title>
    <meta name="robots" content="noindex, follow" />
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/tel-u.png">
                ...
                <div class="col-12 mb-30">
                    <div class="row mbn-15">
                        <div class="col-12 col-md-4 mb-15">
                            <h4 class="text-primary fw-600 m-0">6701190078</h4>
                        </div>
                        <div class="text-left text-md-center col-12 col-md-4 mb-15"><span>Status: <span class="badge badge-round badge-success">Mahasiswa</span></span></div>
                ...
                <div class="col-12 mb-30">
                    <div class="order-details-customer-info row mbn-20">
                        ...
                        <div class="col-lg-3 col-md-12 col-12 mb-30">
                            <h4 class="mb-25">Info Lengkap</h4>
                            <ul>
                                <li> <span>Nama</span> <span>Muhammad Adnan Rizki Issanjaya</span> </li>
                                <li> <span>NIM</span> <span>6701190078</span> </li>
                                <li> <span>Kelas</span> <span>D3SI - 43 01</span> </li>
                                <li> <span>Photo</span> <span><img src="assets/images/Saya.jpeg"></span> </li>
                            </ul>
                        </div>
                        <!--Billing Info End-->
